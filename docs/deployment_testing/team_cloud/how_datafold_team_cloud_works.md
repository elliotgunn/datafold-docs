...
## Comparing production vs staging dbt data 

Datafold in CI automatically identifies data differences between production data and staging data. 

:::tip

Staging data is created using the version of the dbt code in your PR/MR branch. It is stored in a dedicated schema or database.
